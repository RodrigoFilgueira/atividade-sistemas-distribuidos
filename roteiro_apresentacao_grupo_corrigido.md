# 🎬 Roteiro de Apresentação Corrigido — Grupo 5
...
> **Divisão geral:**
> - 🔹 **Rodrigo Cesar** — 1ª Metade: Slides de abertura e Agenda + Teoria de Nuvem, Virtualização e EC2 + Demo ao vivo do EC2 no MiniAWS
> - 🔸 **Pedro Lucas** — 2ª Metade: Teoria de S3 e Lambda + Demo ao vivo de S3, Lambda e integração completa + Tabela comparativa + Referências e Encerramento
...
|:---|:---|:---|
| `00:00 – 00:45` | Slide 1: Capa e abertura | **Rodrigo** |
| `00:45 – 01:15` | Slide 2: Agenda (Ordem do conteúdo) | **Rodrigo** |
| `01:15 – 02:30` | Slide 3: O que é Computação em Nuvem e a AWS | **Rodrigo** |
| `02:30 – 04:30` | Slides 4 e 5: Virtualização: Xen, KVM e AWS Nitro System | **Rodrigo** |
| `04:30 – 05:30` | Slide 6: Amazon EC2 — teoria | **Rodrigo** |
| `05:30 – 06:00` | Slide 7: Apresentação do MiniAWS (arquitetura) | **Rodrigo** |
| `06:00 – 08:00` | 🖥️ **Demo ao vivo — EC2 no MiniAWS** | **Rodrigo** |
| `08:00 – 09:30` | Slide 8: Amazon S3 — teoria | **Pedro** |
| `09:30 – 11:00` | Slide 9: AWS Lambda — teoria | **Pedro** |
...
| `15:30 – 16:30` | Slide 10: Tabela comparativa e aprendizados | **Pedro** |
| `16:30 – 17:00` | Slide 11: Referências e encerramento | **Pedro** |
...
> **💬 Fala (Rodrigo):**
> "Olá, professor, olá a todos. Eu sou o Rodrigo Cesar e, junto com o Pedro Lucas, formamos o Grupo 5. O tema da nossa apresentação é **Computação em Nuvem**, com foco no ecossistema da **Amazon Web Services**. A proposta do nosso trabalho vai além da teoria: nós desenvolvemos, do zero, um simulador funcional chamado **MiniAWS** que reproduz na prática o comportamento dos serviços EC2, S3 e Lambda. Antes de iniciarmos com a parte conceitual e prática, vou apresentar a agenda da nossa apresentação."

⏱️ *Meta: terminar esse slide em ~00:45*

---

### SLIDE 2 — Agenda (Ordem do Conteúdo) — *[NOVO - Obrigatório pelo Edital]*
**Sugestão visual:** Fluxo ou linha do tempo organizada mostrando o percurso da apresentação: Introdução e Virtualização -> EC2 e Demo 1 -> S3/Lambda e Demo 2/3 -> Comparação, Referências e Encerramento.

> **💬 Fala (Rodrigo):**
> "Nossa apresentação está estruturada de forma a cobrir todos os tópicos teóricos e a demonstração prática. Começaremos discutindo o conceito de Computação em Nuvem e a infraestrutura global da AWS. Logo após, abordaremos a evolução tecnológica da virtualização de servidores. Entraremos no serviço de computação Amazon EC2 e passaremos para a nossa primeira demonstração no MiniAWS. Depois, o Pedro assumirá para apresentar o armazenamento de objetos no S3 e a computação serverless com o AWS Lambda, fechando com as demos de integração, resiliência do sistema e a tabela conceitual de mapeamento, encerrando com as nossas referências."

⏱️ *Meta: terminar esse slide em ~01:15*

---

### SLIDE 3 — O que é Computação em Nuvem e a AWS?
...
>
> A AWS é a maior plataforma de nuvem do mundo. Ela organiza sua infraestrutura em **Regiões** — zonas geográficas como São Paulo, Virgínia, Tóquio — e cada Região contém múltiplas **Zonas de Disponibilidade**, que são datacenters fisicamente isolados, mas interconectados por fibra de altíssima velocidade. Essa arquitetura é o que garante a **alta disponibilidade e tolerância a falhas** que estudamos na disciplina."

⏱️ *Meta: terminar esse slide em ~02:30*

---

### SLIDES 4 e 5 — Virtualização: Xen, KVM e AWS Nitro System
...
### SLIDE 7 — Arquitetura do MiniAWS (Transição para a Demo)
...
> ⚠️ **Pedro:** Ao assumir a apresentação, a tela do MiniAWS já está aberta. Mantenha o compartilhamento de tela active. Você vai usá-la novamente a partir do minuto 11:00.

---

### SLIDE 8 — Amazon S3 — Simple Storage Service (Teoria)
...
### SLIDE 9 — AWS Lambda — Computação Serverless (Teoria)
...
### SLIDE 10 — Tabela Comparativa e Aprendizados
**Sugestão visual:** Tabela abaixo em destaque + pontos de aprendizado.
...
> **💬 Fala (Pedro):**
> "Esta tabela resume o mapeamento conceitual do nosso simulador. Cada abstração da AWS foi traduzida para uma estrutura local que preserva a **mesma lógica arquitetural**: isolamento de nós com o EC2, armazenamento de objetos desacoplado com o S3, execução reativa sem servidor com o Lambda e auditoria de eventos distribuídos com o Cloud Logs.
>
> O desenvolvimento do simulador MiniAWS nos proporcionou uma compreensão profunda de como sistemas distribuídos em nuvem gerenciam **estado, eventos e falhas** de maneira desacoplada."

⏱️ *Meta: terminar esse slide em ~16:30*

---

### SLIDE 11 — Referências e Encerramento — *[NOVO - Obrigatório pelo Edital]*
**Sugestão visual:** Título "Referências Bibliográficas" com uma lista bem formatada das fontes e uma mensagem de "Obrigado!".

> **💬 Fala (Pedro):**
> "Para finalizar, estas foram as referências teóricas e técnicas que fundamentaram o nosso trabalho. Consultamos a documentação oficial do ecossistema da AWS para a especificação dos serviços e do hypervisor Nitro, bem como a obra clássica de Sistemas Distribuídos dos autores Tanenbaum e Steen para o embasamento sobre processos, comunicação e tolerância a falhas.
>
> Agradecemos ao professor e a todos pela atenção. Em nome do Grupo 5 — Rodrigo Cesar e Pedro Lucas — estamos abertos a perguntas e discussões. Muito obrigado!"

* **Referências bibliográficas exibidas no slide:**
  1. AMAZON WEB SERVICES (AWS). **Documentação Oficial da AWS (EC2, S3, Lambda, Nitro)**. Disponível em: <https://docs.aws.amazon.com/>. Acesso em: Junho de 2026.
  2. TANENBAUM, Andrew S.; STEEN, Maarten van. **Sistemas Distribuídos: Princípios e Paradigmas**. 3. ed. Editora Pearson, 2017.
  3. AWS WHITEPEPER. **Overview of Amazon Web Services**. Disponível em: <https://docs.aws.amazon.com/whitepapers/>.

⏱️ *Meta: terminar esse slide em ~17:00*
...
- [ ] Limpar dados anteriores: apagar pastas dentro de `/instances` e `/storage`, e esvaziar `instances.json` e `logs.json` (substituir pelo conteúdo `{}` e `[]` respectively)
